...
export default function Contact() {
  ...
  const inputClass = "w-full px-4 py-3 bg-page border border-rule-strong rounded-sm text-primary text-sm focus:outline-none focus:border-accent transition-colors placeholder:text-muted"
              ...
              <div className="space-y-4 text-sm">
                <div className="flex items-center gap-3 py-3 border-b border-rule">
                  ...
                  <div>
                    ...
                    <a href="mailto:arthursouleil@gmail.com" className="text-primary hover:text-accent transition-colors font-medium">arthursouleil@gmail.com</a>
                  </div>
                </div>
                <div className="flex items-center gap-3 py-3 border-b border-rule">
                  <div className="w-8 h-8 rounded-full bg-accent-light flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-center gap-3 py-3">
                  ...
                  <div>
                    ...
                    <a href="https://linkedin.com/in/arthursouleil" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-accent transition-colors font-medium">Arthur Souleil</a>
                  </div>
                </div>
              </div>
            </div>
