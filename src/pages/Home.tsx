...
export default function Home() {
  return (
    <div className="min-h-screen bg-bg">
        ...
        <div className="max-w-content mx-auto px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 min-h-[calc(100vh-64px)] items-center">
            ...
            >
              ...
              <h1 className="font-serif text-hero-mobile md:text-h1 lg:text-hero text-text-primary mb-6 leading-[1.1]">
                Des sites qui{' '}
                <em className="text-accent">honorent</em>{' '}
                votre profession
              </h1>
              <p className="text-body text-text-secondary max-w-[420px] mb-10 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link
                  to="/realisations"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 border border-border-strong text-text-primary font-medium text-sm rounded-sm transition-colors duration-200 hover:border-text-primary"
                >
            ...
            >
              <div className="aspect-[4/5] w-full bg-surface rounded-md relative overflow-hidden">
                <svg className="absolute inset-0 w-full h-full opacity-30" viewBox="0 0 400 500">
                  ...
                  <rect width="100%" height="100%" fill="url(#grid)" className="text-text-tertiary" />
                </svg>
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="font-serif text-[80px] text-text-tertiary/20">AS</span>
                </div>
              </div>
            </motion.div>
          </div>
            ...
            <div className="grid grid-cols-3 divide-x divide-border">
              {[
                ...
                <div key={stat.label} className="py-8 text-center">
                  <div className="font-serif text-h3 md:text-h2 text-text-primary">{stat.value}</div>
                  <div className="font-mono text-label uppercase text-text-tertiary mt-1">{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* Why Jurist Section */}
      <FadeUpSection className="py-24 px-6 lg:px-8 border-t border-border">
        <div className="max-w-content mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <span className="section-label mb-4 block">Pourquoi un juriste ?</span>
              <h2 className="font-serif text-h2 text-text-primary mb-6 leading-tight">
            ...
            <div className="relative">
              <div className="aspect-[4/5] bg-surface rounded-md relative overflow-hidden">
                <div className="absolute inset-0 flex flex-col justify-end p-8">
                  <span className="font-mono text-label uppercase text-text-tertiary mb-2">Formation</span>
                  <span className="font-serif text-h3 text-text-primary">UT1 Capitole</span>
                  <span className="font-serif text-h3 text-text-primary">Assas Paris II</span>
                  <div className="mt-4 h-[1px] bg-border-strong" />
                  <span className="font-mono text-label uppercase text-text-tertiary mt-4">Préparation CRFPA 2025</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <FadeUpSection>
            <div className="flex items-end justify-between mb-12">
              <div>
                ...
                <h2 className="font-serif text-h2 text-text-primary">Réalisations récentes</h2>
              </div>
              <Link
                to="/realisations"
              ...
              <StaggerItem key={project.name}>
                ...
                >
                  <div className="aspect-[16/10] bg-surface-hover relative overflow-hidden">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className="font-serif text-3xl text-text-tertiary group-hover:text-text-primary transition-colors duration-200">
                        {project.name}
                      </span>
                    </div>
                  </div>
                  <div className="p-5 flex items-center justify-between border-t border-border">
                    <div>
                      <h3 className="font-serif text-lg text-text-primary mb-0.5 group-hover:text-accent transition-colors duration-200">
                        {project.name}
                      </h3>
      ...
      <section className="py-24 px-6 lg:px-8 bg-surface border-t border-border">
        <div className="max-w-content mx-auto text-center">
          <FadeUpSection>
            ...
            <h2 className="font-serif text-h2 md:text-h1 text-text-primary mb-6 leading-tight">
            ...
            <Link
              to="/contact"
              className="inline-flex items-center gap-3 px-10 py-5 bg-text-primary text-bg font-semibold text-base rounded-sm transition-opacity duration-200 hover:opacity-85"
            >
              Prendre rendez-vous
